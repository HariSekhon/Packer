...
#
# Must run 'scripts/debian-prepare.sh' first to download the ISO and generate another ISO with the preseed.cfg
#
...
source "tart-cli" "debian" {
  ...
  from_iso     = ["isos/cidata.iso", "isos/debian-11.7.0-arm64-DVD-1.iso"]
  cpu_count    = 2
  memory_gb    = 2
  disk_size_gb = 40
  boot_wait    = "5s"
