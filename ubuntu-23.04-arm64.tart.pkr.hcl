...
#
# Must run 'scripts/prepare-ubuntu-23.04.sh' first to download the ISO and generate another ISO with the AutoInstaller config
#
...
source "tart-cli" "ubuntu-23" {
  ...
  from_iso = [
    ...
    "isos/ubuntu-23.04.2-live-server-arm64.iso"
  ]
  cpu_count    = 4
  memory_gb    = 4
  disk_size_gb = 40
